...
repository contains the solution for Laboratory 2 in Computer Science 111.
...
line of output will contain the name of the programmer and the date at which the
program was run. The next three lines will feature the output of numerical
values, with the final line outputting the result of a computation with
variables. As verified by
[Checkstyle](https://github.com/checkstyle/checkstyle), the source code for the
`ComputeMoonDistance.java` file must adhere to all of the requirements in the [Google
...
For instance, GatorGrader will check to ensure that `ComputeMoonDistance`
produces exactly four lines of output and that you use the `new Date()`
construct in the Java code. GatorGrader will also check that your program
performs the correct computation and produces the expected output for the number
of yards to the moon.
...
output for the instructor's version of `ComputeMoonDistance`. As long as your program
...
```
Gregory M. Kapfhammer Wed Sep 06 16:22:21 EDT 2017
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-111-F2017/cs111-F2017-lab2-starter.git
```
...
you can go to the [Computer Science 111 Lab 2
Starter](https://github.com/Allegheny-Computer-Science-111-F2017/cs111-F2017-lab2-starter)
